...
import sys, re, os
sys.path.insert(0, "../../")
from gnn_fp.preprocess.graph_transformer import *
from gnn_fp.preprocess.prepare_dataset_pmoo import *
from gnn_fp.preprocess.prepare_dataset_deborah import *
from gnn_fp.model.train_model import *
from dataset_creation.large_network_generation.large_network_generation.network_structure.network_structure_pb2 import *
...
def write_network(network, flows_start_sink, foi, filename):
    ...
    with write_pbz(filename, "../../dataset_creation/large_network_generation/network_structure/network_structure.descr") as w:
        for obj in objs:
            w.write(obj)
